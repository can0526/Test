		...
		<div class="agileits_header">
			<div class="container">
				<div class="w3l_offers">
					<p>打折销售高达70%。 <a href="products.html">现在购物</a></p>
				</div>
				<div class="agile-login">
					<ul>
						<li><a href="registered.html"> 创建用户 </a></li>
		...
		<div class="logo_products">
			...
			<div class="w3ls_logo_products_left1">
					<ul class="phone_email">
						<li><i class="fa fa-phone" aria-hidden="true"></i>网上订购或致电:(+0123)234567</li>
					</ul>
				</div>
				...
				<nav class="navbar navbar-default">
								...
								<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
									<ul class="nav navbar-nav">
										<li class="active" style="margin-left: 50px;"><a href="index.html" class="act">首页</a></li>	
										<li style="margin-left: 50px;"><a href="products.html">食品杂货</a></li>
										<li style="margin-left: 50px;"><a href="products.html">家庭</a></li>
										<li style="margin-left: 50px;"><a href="products.html">个人护理</a></li>
										<li style="margin-left: 50px;"><a href="products.html">包装食品</a></li>
										<li style="margin-left: 50px;"><a href="products.html">饮料</a></li>
										<li style="margin-left: 50px;"><a href="products.html">美食</a></li>
									</ul>
								</div>
								</nav>
				</div>
				...
				<div class="grid_3 grid_5">
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">广告提供</a></li>
							<li role="presentation"><a href="#tours" role="tab" id="tours-tab" data-toggle="tab" aria-controls="tours">近日推荐</a></li>
						</ul>
				...
				<div class="w3_footer_grids">
					...
					<div class="col-md-3 w3_footer_grid">
						...
						<ul class="info"> 
							...
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="javaScript:void(0);">短码</a></li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="javaScript:void(0);">FAQ's</a></li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="javaScript:void(0);">特殊的产品</a></li>
						</ul>
					</div>
					<div class="col-md-3 w3_footer_grid">
						<h3>类别</h3>
						<ul class="info"> 
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="groceries.html">食品杂货</a></li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="household.html">家庭</a></li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="personalcare.html">个人护理</a></li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="packagedfoods.html">包装食品</a></li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="beverages.html">饮料</a></li>
						</ul>
					</div>
					<div class="col-md-3 w3_footer_grid">
						<h3>简况</h3>
						<ul class="info"> 
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="products.html">商店</a></li>
							...
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="registered.html">创建账户</a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>
				</div>
