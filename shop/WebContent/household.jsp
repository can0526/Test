		...
		<div class="container">
			<div class="col-md-4 products-left">
				<div class="categories">
					<h2>类别</h2>
					<ul class="cate">
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>水果和蔬菜</a></li>
							<ul>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>豆芽</a></li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>花</a></li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>新鲜香草 & 调味料</a></li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>新鲜蔬菜</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>进口蔬菜</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>有机水果 & 蔬菜</a></li>
							</ul>
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>杂货</a></li>
							<ul>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>木豆</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>干果</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>食用油 & 酥油</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>面粉</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>香料</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>有机原料</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>米产品</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>盐&糖</a></li>
							</ul>
						<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>个人护理</a></li>
							<ul>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>婴儿护理</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>化妆品</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>香水</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>皮肤护理</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>口腔护理</a> </li>
								<li><a href="products.html"><i class="fa fa-arrow-right" aria-hidden="true"></i>剃须的产品</a></li>
							</ul>
					</ul>
				</div>																																												
			</div>
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
					<div class="products-right-grids">
						...
						//ajax异步分页
						 function page1(a){
								var pname=$("#sousuo").val();
								var i=a.selectedIndex;
								 var v=a.options[i].value;
// 								window.location="${pageContext.request.contextPath }/product?method=searchProductByPage&pname="+pname+"&pageSize="+v;
								$.post("${pageContext.request.contextPath }/product?method=searchProductByPage",
													{"pname":pname,"pageSize":v},
											  function(pageBean){
														alert(pageBean.list[1].pname);
...
<%-- 								<option value="-1" selected="9==${pageBean.pageSize }?'selected'" onclick="page(18)">全部</option>								 --%>
							...
							<input type="hidden" name="pname" id="pname" value="${pageBean.list[0].pname }">
						</div>
						</form>
				...
				<h1 style="color:red;">没有你要搜索的商品!</h1>
